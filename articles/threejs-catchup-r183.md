...
## はじめに
いつの間にか知らない機能が追加されていたり書き方が変わっているthree.jsをキャッチアップする目的で、AI要約でexamplesの更新を追い、不明点を調査しつつ、WebGPU時代のレンダリングパイプライン設計の変化を読み解きながら、バージョンアップの移行詳細を記録する。
...
- Inspector知らない間に便利になってる!?使っていきたい。
  ※webgpuのみで利用できて、webglでは利用できなさそう。
