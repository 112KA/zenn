...
- [OpenUSDの Kitchen Set](https://t.co/CqCgWMVi0p)が読み込めた。
    ※`OpenUSDの Kitchen Set` - ピクサー（Pixar）が公開している、USD（Universal Scene Description）の機能を網羅的にデモンストレーションするための代表的なサンプルデータセットです。
